package com.intelligentmusicplayer.android.stepcount;
...
import com.intelligentmusicplayer.android.UpdateUiCallBack;
...
public class StepCountService extends Service implements SensorEventListener {
     ...
     */
    private StepBinder lcBinder = new StepBinder();
    /**
     * 当前步数
     */
    ...
    private void addCountStepListener() {
        ...
        if (countSensor != null) {
            ...
            sensorManager.registerListener(StepCountService.this, countSensor, SensorManager.SENSOR_DELAY_NORMAL);
            Log.i("计步传感器类型", "Sensor.TYPE_STEP_COUNTER");
        } else if (detectorSensor != null) {
            stepSensorType = Sensor.TYPE_STEP_DETECTOR;
            sensorManager.registerListener(StepCountService.this, detectorSensor, SensorManager.SENSOR_DELAY_NORMAL);
        } else {
            addBasePedometerListener();
        }
    }
